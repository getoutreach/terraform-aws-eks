...
//this might be more difficult?
  iam_instance_profile {
    name = lookup(aws_iam_instance_profile.workers_map, each.value["name"], null) == null ? aws_iam_instance_profile.workers_map[each.value["name"]].name : data.aws_iam_instance_profile.custom_workers_map_iam_instance_profile[each.value["name"]].name
  }
